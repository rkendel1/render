...
`zod ^4.0.0` is required for all renderers. Additional peer dependencies depend on your renderer:

- **React:** `react ^19.0.0` and `zod ^4.0.0`
- **Vue 3:** `vue ^3.5.0` and `zod ^4.0.0`
